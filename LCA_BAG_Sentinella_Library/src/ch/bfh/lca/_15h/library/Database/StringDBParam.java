 ...
 */
public class StringDBParam extends ADBParameter<String> implements IDBParameter {
     ...
     * @param value - Integer
     */
    public StringDBParam(int index, String value) {
        super(index, value);
    }
    ...
    public PreparedStatement addParamToStatement(PreparedStatement statement) throws SQLException{
        ...
        resultStatement.setString(this.getIndex(), this.getValue());
